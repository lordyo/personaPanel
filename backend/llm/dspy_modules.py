...
# Note: The SoloInteractionSimulator, DyadicInteractionSimulator, and GroupInteractionSimulator
# classes have been removed in favor of the unified InteractionSimulator in interaction_module.py 